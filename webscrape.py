...
if askCompare == "Y": # If statements asking user if they want to compare two colleges.
    ...
    inStateCost = soup3.find_all('div', class_="large font-weight-bold fw-bold") # Finds instate/out of state cost of attendence for college 1
    inStateCost2 = soup6.find_all('div', class_="large font-weight-bold fw-bold") # Finds instate/out of state cost of attendence for college 2
    ...
    publicOrPrivate = print("Public or Private: " + publicOrPrivate[0].text) # Displays whether the college is a public or private university
    population = print("Undergraduate Population: " + undergrad[2].text) # Displays undergraduate population
    applicationnumbers = print("Number of Applicants: " + acceptanceRate[1].text) # Displays the number of applications the college recieved
    acceptancerate = print("Acceptance Rate: " + acceptanceRate[0].text) # Displays the acceptance rate of the university
    ...
    studenttofacultyratio = print("Student to faculty ratio: " + acceptanceRate[5].text) # Displays the student to faculty ratio
    print("--------------------------------------")
    ...
    averageEnglishSAT = print("Average English SAT: " + sat[5].text) # Displays the average reading and writing SAT of the university
    print("--------------------------------------")
    print("ACT")
    ...
    averageEnglishACT = print("Average English ACT: " + act[10].text) # Displays the average reading and writing ACT score
    print("--------------------------------------")
    inStateCOA = print("In state cost: " + inStateCost[0].text) # Displays the cost of attendance for in-state students
    outOfStateCOA = print("Out of state cost: " + inStateCost[1].text) # Displays the cost of attendance for out-of-state students
    ...
    publicOrPrivate2 = print("Public or Private: " + publicOrPrivate2[0].text) # Displays whether the college 2 is a public or private university 
    population2 = print("Undergraduate Population: " + undergrad2[2].text) # Displays undergraduate population of college 2
    applicationnumbers2 = print("Number of Applicants: " + acceptanceRate2[1].text) # Displays the number of applications college 2 recieved 
    ...
    studenttofacultyratio2 = print("Student to faculty ratio: " + acceptanceRate2[5].text) # Displays the student to faculty ratio of college 2
    print("--------------------------------------")
    ...
    averageEnglishSAT2 = print("Average English SAT: " + sat2[5].text) # Displays average reading and writing of college 2
    print("--------------------------------------")
    print("ACT")
    ...
    averageEnglishACT2 = print("Average English ACT: " + act2[10].text) # Displays average reading and writing of college 2
    print("--------------------------------------")
    inStateCOA2 = print("In state cost: " + inStateCost2[0].text) # Displays the cost-of-attendance for in-state students
    outOfStateCOA2 = print("Out of state cost: " + inStateCost2[1].text) # Displays the cost-of-attendance for in-state students

elif (askCompare == "N"): # If user doesn't want to compare colleges
    input1 = input("Enter the full name of the university: ")
    print("--------------------------------------")

    if input1 == "Indiana University Bloomington":
        print("IU Sucks! Boiler Up!")
    ...
    publicOrPrivate = print("Public or Private: " + publicOrPrivate[0].text) # Displays whether it's a public or private school
    population = print("Undergraduate Population: " + undergrad[2].text) # Displays undergraduate population
    applicationnumbers = print("Number of Applicants: " + acceptanceRate[1].text) # Displays the amount of applicants the college recieved
    acceptancerate = print("Acceptance Rate: " + acceptanceRate[0].text) # Displays the acceptance rate of the university
    ...
    studenttofacultyratio = print("Student to faculty ratio: " + acceptanceRate[5].text) # Displays the student to faculty ratio of the university
    print("--------------------------------------")
    asianDiversity = print(Diversity[0].text) # Displays the asian population
    blackDiversity = print(Diversity[1].text) # Displays the black population
    hispanicDiversity = print(Diversity[2].text) # Displays the hispanic population
    ...
    averageEnglishSAT = print("Average English SAT: " + sat[5].text) # Displays the average reading and writing of the college 
    print("--------------------------------------")
    print("ACT")
    ...
    averageEnglishACT = print("Average English ACT: " + act[10].text) # Displays the average reading and writing ACt of the college 
    print("--------------------------------------")
    inStateCOA = print("In state cost: " + inStateCost[0].text) # Displays the cost-of-attendance for in-state students
    outOfStateCOA = print("Out of state cost: " + inStateCost[1].text) # Displays the cost-of-attendance for out-of-state students 
else: {
